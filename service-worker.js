const CACHE='metro-pwa-v10';
const ASSETS=['./','index.html','styles.css','app.js','transit-data.json','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','audio/gonga.wav','audio/gongb.wav','audio/gongc.wav'];
